...
<head>
    ...
    <meta name="description" content="@yield('meta-description', 'Gioielleria Mari description')">
...
<nav class="mx-auto max-w-7xl px-6 lg:px-8" aria-label="Top">
        <div class="flex w-full items-center justify-between border-b border-gray-700 py-6 lg:border-none">
            ...
            <div class="ml-10 space-x-8">
                ...
                <a href="/chi-siamo" class="text-base font-medium text-white hover:text-gray-300">Chi Siamo</a>
                <a href="/prodotti" class="text-base font-medium text-white hover:text-gray-300">Prodotti</a>
                <a href="/contatti" class="text-base font-medium text-white hover:text-gray-300">Contatti</a>
            </div>
        </div>
    </nav>
</header>
