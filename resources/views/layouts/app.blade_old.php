    ...
    <nav class="mx-auto max-w-7xl px-8 lg:px-16" aria-label="Top">
        <div class="flex w-full items-center justify-between py-6">
            <a href="/" class="flex items-center">
                <span class="font-cursive text-white text-4xl sm:text-4xl">Gioielleria Antonio Mari</span>
            </a>
            <div class="hidden lg:flex lg:items-center lg:space-x-8">
                @if(!Request::is('/'))
                    <a href="/" class="text-base font-medium tracking-wider text-muted hover:text-white transition-colors">Home</a>
                @endif
                <a href="/chi-siamo" class="text-base font-medium tracking-wider text-muted hover:text-white transition-colors">Chi Siamo</a>
                <a href="/prodotti" class="text-base font-medium tracking-wider text-muted hover:text-white transition-colors">Prodotti</a>
                <a href="{{ route('repair.search') }}" class="text-base font-medium tracking-wider text-muted hover:text-white transition-colors">Stato Riparazione</a>
                <a href="/contatti" class="text-base font-medium tracking-wider text-muted hover:text-white transition-colors">Contatti</a>
            </div>
            <div class="lg:hidden">
...
<footer class="bg-third-tone border-t border-white/10" aria-labelledby="footer-heading">
        <h2 id="footer-heading" class="sr-only">Footer</h2>
        <div class="mx-auto max-w-7xl px-6 pb-4 pt-4 sm:pt-24 lg:px-8 lg:pt-32">
